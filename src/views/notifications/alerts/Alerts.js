...
const Alerts = () => {
	return (
		<CRow>
			<CCol xs={12}>
				<DocsCallout name="Alert" href="src/views/alert" />
			</CCol>
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/alert">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/alert#link-color">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/alert#additional-content">
							<CAlert color="success">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/alert#dismissing">
							<CAlert
								color="warning"
								dismissible
								onClose={() => {
