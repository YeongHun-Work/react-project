...
const Badges = () => {
	return (
		<CRow>
			<CCol xs={12}>
				<DocsCallout name="Badges" href="src/views/badge" />
			</CCol>
			<CCol lg={6}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/badge">
							<h1>
			...
			<CCol lg={6}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/badge#contextual-variations">
				...
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/badge#pill-badges">
