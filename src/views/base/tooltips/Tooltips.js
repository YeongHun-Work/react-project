...
const Tooltips = () => {
	return (
		<CRow>
			<CCol xs={12}>
				<DocsCallout name="Tooltip" href="src/views/tooltip" />
			</CCol>
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/tooltip">
						...
						<p className="text-medium-emphasis small">Hover over the buttons below to see the four tooltips directions: top, right, bottom, and left. Directions are mirrored when using CoreUI in RTL.</p>
						<DocsExample href="src/views/tooltip">
