...
const Progress = () => {
	return (
		<CRow>
			<CCol xs={12}>
				<DocsCallout name="Progress" href="src/views/progress" />
			</CCol>
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/progress">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/progress#labels">
							<CProgress className="mb-3">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						<p className="text-medium-emphasis small">
							We only set a <code>height</code> value on the <code>&lt;CProgress&gt;</code>, so if you change that value the inner <code>&lt;CProgressBar&gt;</code> will automatically resize accordingly.
						</p>
						<DocsExample href="src/views/progress#height">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/progress#backgrounds">
							<CProgress className="mb-3">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						<p className="text-medium-emphasis small">Include multiple progress bars in a progress component if you need.</p>
						<DocsExample href="src/views/progress#multiple-bars">
							<CProgress className="mb-3">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						<p className="text-medium-emphasis small">
							Add <code>variant=&#34;striped&#34;</code> to any <code>&lt;CProgressBar&gt;</code> to apply a stripe via CSS gradient over the progress bar&#39;s background color.
						</p>
						<DocsExample href="src/views/progress#striped">
							<CProgress className="mb-3">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						<p className="text-medium-emphasis small">
							The striped gradient can also be animated. Add <code>animated</code> property to <code>&lt;CProgressBar&gt;</code> to animate the stripes right to left via CSS3 animations.
						</p>
						<DocsExample href="src/views/progress#animated-stripes">
							<CProgress className="mb-3">
