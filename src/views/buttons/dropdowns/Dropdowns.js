...
const Dropdowns = () => {
	return (
		<CRow>
			<CCol xs={12}>
				<DocsCallout name="Dropdown" href="src/views/dropdown" />
			</CCol>
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/dropdown#single-button">
							<CDropdown>
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/dropdown#split-button">
							<>
								{["primary", "secondary", "success", "info", "warning", "danger"].map((color, index) => (
									<CDropdown variant="btn-group" key={index}>
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/dropdown#sizing">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/dropdown#dark-dropdowns">
							<CDropdown dark>
								<CDropdownToggle color="secondary">Dropdown button</CDropdownToggle>
								<CDropdownMenu>
									<CDropdownItem href="#">Action</CDropdownItem>
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/dropdown#dropup">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/dropdown#dropright">
			...
			<CCol xs={12}>
				<CCard className="mb-4">
					...
					<CCardBody>
						...
						<DocsExample href="src/views/dropdown#dropleft">
							<CButtonGroup>
